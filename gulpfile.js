    ...
    var gulp = require( 'gulp' ),
        ...
        files = {
            ...
            defaultJS: [
                ...
                'app/js/constants/FormMessages.js',
                'app/js/constants/ModalMessages.js',
                'app/js/constants/ModalDefinitions.js',
                'app/js/constants/AlertMessages.js',
                'app/js/constants/URLParams.js',
                // controllers
                'app/js/controllers/ModalCtrl.js',
                'app/js/controllers/FormExampleCtrl.js',
                'app/js/controllers/ModalExampleCtrl.js',
                'app/js/controllers/AjaxExampleCtrl.js',
                // directives
                'app/js/directives/loading.js',
                'app/js/directives/alertMessage.js',
                'app/js/directives/goTop.js',
                'app/js/directives/fieldMessage.js',
                'app/js/directives/validateDate.js',
                // factories
